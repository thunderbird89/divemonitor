...
/**
 * An activity representing a list of Dives. This activity
 * has different presentations for handset and tablet-size devices. On
 * handsets, the activity presents a list of items, which when touched,
 * lead to a {@link DiveDetailActivity} representing
    ...
    public class SimpleItemRecyclerViewAdapter
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.dive_list_content, parent, false);
            ...
            holder.mView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mTwoPane) {
                        ...
                        arguments.putString(DiveDetailFragment.ARG_ITEM_ID, holder.mItem.id);
                        ...
                        intent.putExtra(DiveDetailFragment.ARG_ITEM_ID, holder.mItem.id);
