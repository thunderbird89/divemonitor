package tech.provingground.divemonitor.activity;
...
import tech.provingground.divemonitor.sensorium.LightLevelHandler;
import tech.provingground.divemonitor.sensorium.OrientationHandler;
import tech.provingground.divemonitor.sensorium.PressureHandler;
import tech.provingground.divemonitor.sensorium.TemperatureHandler;
...
public class Monitor extends WearableActivity {
	...
	protected void onNewIntent(Intent intent) {
		...
		setIntent(intent);
		if (!"tech.provingground.divemonitor.START_MONITORING".equals(intent.getAction())) {
			refreshAndReschedule();
		}
	}
